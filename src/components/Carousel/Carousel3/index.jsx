// src/components/Carousel/Carousel3.jsx
  ...
  return (
    <div className="w-full py-4 px-2 bg-white/10 backdrop-blur-md rounded-lg">
      <Swiper
        ...
        breakpoints={{
          640: { slidesPerView: 1.3, slidesPerGroup: 1 },  // tablet
          768: { slidesPerView: 1.5, slidesPerGroup: 1 },  // desktop
          1024: { slidesPerView: 1.7, slidesPerGroup: 1 }, // large
          1280: { slidesPerView: 1.9, slidesPerGroup: 1 }, // extra large
        }}
      >
